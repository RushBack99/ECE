...
\usepackage{arydshln}               % dashed/dotted lines in tables
...
% --------------------------------------- COLOR DEFINITIONS ---------------------------------------
\definecolor{sectioncolor}{HTML}{ff6c17}
\definecolor{subsectioncolor}{HTML}{fc9153}
...
\newcommand{\cdgn}[1]{{\color{darkgreen}#1}}
