...
%----------------------------------------------------------------------------------------------
%-----------------     1.6 Lineare Approximation / Differenzial diff y    --------------------
%----------------------------------------------------------------------------------------------
\subsection[Lineare Approximation / Differenzial diff y]{Lineare Approximation / Differenzial $\diff y$}{459}

Differenzial $= \diff y = \diff f =$ "Höhenunterschied der Tangente" $=$ "Linearzuwachs"

\textcolor{blue}{Differenzial: $\diff y = f'(x_0) \cdot \diff x$} $= f'(x_0) \cdot h = f'(x_0) \cdot \Delta x = f'(x_0) \cdot (x- x_0) $
\begin{center}
    \includegraphics[width=0.58\columnwidth]{images/differenzial.PNG}
\end{center}

\begin{minipage}[c]{0.48\columnwidth}
    $\Delta y \approx \diff y$ \textrightarrow\ Approximation / Fehler
\end{minipage}
\hfill
\begin{minipage}[c]{0.48\columnwidth}
    Fehler: \quad $\Delta y - \diff y \rightarrow 0$ \quad $h \rightarrow 0$
\end{minipage}
...
\begin{tabular}{llclcll}
    ...
    $ R_2(x)$ &$=$& $f(x)-\hat f(x)$ &$=$& $\abs{2.024845 - 2.025}$ &$=$& $0.0000155$\\
    \hline
              &   & $ R_1(x)$ &$=$& $ R_2(x)$ &$=$& $\fbox{0.0000155}$
\end{tabular}

%----------------------------------------------------------------------------------------------
%------------------------------     1.8 Fehlerfortpflanzung    --------------------------------
%----------------------------------------------------------------------------------------------
...
\begin{tabular}{llll}
    Absolut: & $\cbl{\Delta x \rightarrow \Delta y}$                & & 
               $\cgn{\Delta y \approx dy = f'(x_0) \cdot \Delta x}$                                              \\
    Relativ: & $\cor{\Delta x \rightarrow \frac{\Delta y}{y_0}}$    & &  
               $\cvt{\frac{\Delta y}{y_0} \approx \frac{\diff y}{y_0} = \frac{f'(x_0) \cdot \Delta x}{f(x_0)}}$ 
\end{tabular}
\renewcommand{\arraystretch}{1}
...
\begin{minipage}[c]{0.5\columnwidth}
    ...
    \begin{tabular}{|@{}| c | c | c |@{}}
    \hline
                                                            & $\Delta x $ (abs)    & $\frac{\Delta x}{x}$ (rel)    \\
    \hline
